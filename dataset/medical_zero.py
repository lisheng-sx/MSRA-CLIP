...
CLASS_NAMES = ['Brain', 'Liver', 'Retina_RESC', 'Retina_OCT2017', 'Histopathology']
    ...
    def load_dataset_folder(self):
        ...
        for class_name_one in CLASS_NAMES:
            if class_name_one != self.class_name:
                ...
                # self.dataset_pathplus = self.dataset_path + class_name_one
                ...
                for f in os.listdir(img_dir):
                    ...
                    # print('data_img',data_img)#'./data/Liver_AD/test/good/img/5_312.png', 0
...
class MedTestDataset(Dataset):
    def __init__(self,
        ...
        self.class_name = class_name
        self.seg_flag = CLASS_INDEX[class_name]#查找 class_name 在 CLASS_INDEX 字典中的索引值
        self.resize = resize
